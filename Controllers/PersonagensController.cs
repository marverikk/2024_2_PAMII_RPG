...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensController : ControllerBase
    {
        ...
        public PersonagensController(DataContext context, IConfiguration _configuration, IHttpContextAccessor _httpContextAcessor)
        {
            _context = context;
            _configuration = configuration;
            _httpContextAcessor = _httpContextAcessor;
        }
